...
function Photography() {
    ...
    useEffect(() => {
        const masker = document.querySelector('#section2 .other-bodies')
        ...
        `;
        {
            ...
            function resize() {
                gl.canvas.width = masker.clientWidth;
                gl.canvas.height = masker.clientHeight;
                gl.canvas.style.width = masker.clientWidth + "px";
                gl.canvas.style.height = masker.clientHeight + "px";

                var a1, a2;
                var imageAspect = _size[1] / _size[0];
                if (masker.clientHeight / masker.clientWidth < imageAspect) {
                    a1 = 1;
                    a2 = masker.clientHeight / masker.clientWidth / imageAspect;
                } else {
                    a1 = masker.clientWidth / masker.clientHeight * imageAspect;
                    a2 = 1;
                }
                ...
                renderer.setSize(masker.clientWidth, masker.clientHeight);
                aspect = masker.clientWidth / masker.clientHeight;
            }
            ...
            var program = new Program(gl, {
                ...
                uniforms: {
                    ...
                    res: {
                        value: new Vec4(masker.clientWidth, masker.clientHeight, a1, a2)
                    },
            ...
            if (isTouchCapable) {
                masker.addEventListener("touchstart", updateMouse, false);
                masker.addEventListener("touchmove", updateMouse, { passive: false });
            } else {
                masker.addEventListener("mousemove", updateMouse, false);
            }
            var lastTime;
        ...
        const textCircle = document.querySelectorAll('.text-circle')

        textCircle.forEach((elem,i) => {
            elem.innerHTML =  elem.innerHTML.split("").
                map((char,idx) => {
                    return `<span style = "transform:rotate(${idx*9}deg)"> ${char} </span>`
                }).join("") 
        })
    },[])
    ...
    return (
        <div className='container-fluid'>
                    ...
                    <div className="col-md-5 p-md-3">
                        <div className="card card-img">
                            <div className="imgContainer">
                                <div className="image-box p-sm-5">
                                    <img src="./design/b6.png" alt="" />
                                </div>
                                <div className="imgbuttons row align-items-center justify-content-evenly">

                                    <div className="col-2 m-1 circle">
                                        <svg width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M24.6437 0.528228L38.1084 1.50393C38.9347 1.5638 39.556 2.28216 39.4961 3.10842L38.5204 16.5731C38.4605 17.3994 37.7422 18.0207 36.9159 17.9608C36.0896 17.9009 35.4684 17.1825 35.5282 16.3563L36.2422 6.50344L1.98124 36.1346L0.0187884 33.8655L34.2798 4.23436L24.4269 3.52038C23.6007 3.46051 22.9794 2.74215 23.0392 1.91589C23.0991 1.08963 23.8175 0.468353 24.6437 0.528228Z" fill="black"/>
                                        </svg>
                                    </div>
                                    <div className="col-2 m-1 circle">
                                        <svg width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="col-2 m-1 circle text">
                                        <h2> T1 </h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card photo-text">
                            ...
                            <div className="sub-text">
                                ...
                                <div className="intro-sub-text">
                                    <div className="intro-title offset-2">
                                        <h3>
                                            Portrait
                                        </h3>
                                    </div>
                                    <div className="intro-text">
                                        <h4>
                                            Neon light photography is any type of photography 
                                            that features neon lights. 
                                        </h4>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="section3">
                <div className="row row-cols-lg-3 align-items-center justify-content-center">
                    <div className="col-lg-4 p-sm-2">
                        <div className="card p-sm-2">
                            <div className="imgCard">
                                <img src="./design/b2.png" alt="" />
                                <div className="text-circle-outside">
